...
namespace TicTacToe
{
    public partial class FrmTicTacToe : Form
    {
        ...
        //СКРЫТЬ ОТОБРАЗИТЬ КНОПКИ ИГРОК ПРОТИВ ПК, ИГРОК ПРОТИВ ИГРОКА, НОВАЯ ИГРА НА МЕНЮ
        ...
        //МЕСТОПОЛОЖЕНИЕ МЕТОК,СЧЕТ,ХОД, НОВАЯ ИГРА И СБРОС
        ...
        // КНОПКА ВЫХОД
        private void ButtonMouseEnter(Panel buttonPanel)  // ЦВЕТ 
        {
          
            buttonPanel.BackColor = Color.DarkSlateGray;
            Cursor = Cursors.Hand;
        }
        ...
        {
            panelCloseButton.BackColor = Color.Teal;
        ...
        private void CellMouseOver(object sender)  //ЦВЕТ
        {
            if (sender is Panel)
            {
                Panel panelCell = (Panel)sender;
                panelCell.BackColor = Color.DarkSlateGray;// вот здесь менять цвет
                Cursor = Cursors.Hand;
            }
        }
        private void CellMouseOut(object sender)
        {
            ...
            {
                Panel panelCell = (Panel)sender;
                panelCell.BackColor = Color.Teal;
                Cursor = Cursors.Default;
            }
        }
        private void FillCell(Panel panel, int row, int column)
        {
            ...
            {
                // ЕСЛИ ИГРА НЕ НАЧАЛАСЬ, ВОЗРАЩЕНИЕ НАЗАД
                return;
            }
            ...
            if (engine.IsWin())
            {
                // РЕЗУЛЬТАТ, ЧТО ПРОИЗОШЛА ПОБЕДА
        ...
        //ИГРОК ПРОТИВ ИГРОКА ПК ПРОТИВ ИГРОКА
        private void RegularButtonMouseOver(Panel panelButton, Label labelButtonText)
        {
            panelButton.BackColor = Color.DarkSlateGray;
        ...
        {
            panelButton.BackColor = Color.Teal;
            labelButtonText.ForeColor = Color.Cyan;
            Cursor = Cursors.Default;
        }
        ...
        //отображение/скрытие имён игроков, метки с указанием хода, а также кнопок "Сброс" и "Новая игра":
